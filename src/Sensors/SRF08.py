...
class SRF08:
    ...
    def __init__(self, address=0xE0, mode=2, debug=False):
        ...
        self.mode = mode
        self.range_mm = 11008
        self.i2c.write8(self.SRF08_RANGE, (
        (self.range_mm - 43) / 43))  # If range_mm != 11008, you should change the default gain of the sensor
            ...
            if (self.mode == 1):
                ...
                while flag:
                    ...
                    try:
                        ...
                        i = 0
                        while i < 17:
                            self.echo[i] = self.i2c.readU8(self.SRF08_ECHO_1_LSB + (2 * i)) + 255 * (
                            self.i2c.readU8(self.SRF08_ECHO_1_MSB + (2 * i)) * 255)
                            i += 1
                    except IOError:
                        print "IOError"
                        flag = 1
                ...
                while flag:
                    ...
                    try:
                        ...
                        i = 0
                        while i < 17:
                            self.echo[i] = self.i2c.readU8(self.SRF08_ECHO_1_LSB + i) + 255 * (
                            self.i2c.readU8(self.SRF08_ECHO_1_MSB + i) * 255)
                            i += 1
                    except IOError:
                        print "IOError"
                        flag = 1
            ...
            if (self.mode == 1):
                ...
                while flag:
                    ...
                    try:
                        self.i2c.write8(self.SRF08_COMMAND, self.SRF08_RANGING_MODE_RESULT_INCHES)
                        time.sleep(0.005 + self.range_mm * 0.065 / 11008)
                        self.echo[echo_num - 1] = self.i2c.readU8(
                            self.SRF08_ECHO_1_LSB + (2 * (echo_num - 1))) + 255 * (
                        self.i2c.readU8(self.SRF08_ECHO_1_MSB + (2 * (echo_num - 1))))
                    except IOError:
                        print "IOError"
                        flag = 1
            elif (self.mode == 2):
