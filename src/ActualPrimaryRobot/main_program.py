...
def initialize_node():
    ...
    while not rospy.is_shutdown():
        ...
        elif state = pid_move_state:
            if (abs(set_point - motor_controller.))
        rate.sleep()
