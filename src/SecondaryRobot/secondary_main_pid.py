    ...
    while not rospy.is_shutdown():
        ...
        if state == States.WAIT_FOR_START_BUTTON:
            ...
            if abs(leftPID.getError()) > 0.01:
                if motor_controller.get_left_distance() > 0.6*set_point_left:
            ...
            if abs(rightPID.getError()) > 0.01:
                if motor_controller.get_right_distance() > 0.6*set_point_right:
            ...
            print("SETPOINT={}, ACTUALLEFT={},ACTUALRIGHT={}".format(set_point_left, motor_controller.get_left_distance(), motor_controller.get_right_distance()))
